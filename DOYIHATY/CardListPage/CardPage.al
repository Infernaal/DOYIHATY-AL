page 50104 "Card Page by DOYIHATY"
{
            ...
            group("Vehicle Information")
            {
                grid(GeneralGrid)
                {
                    group(General)
                    {
                        ...
                        {
                            ApplicationArea = All;
                            ToolTip = 'Specifies the name of the parking center.';
                            Editable = false;
                        }
    ...
    begin
        ...
        then begin
            Rec."Place Truck" := 'Have truck slot';
        end else begin
            Rec."Place Truck" := 'Not have truck slot';
        end;
    ...
    begin
        Rec."Place Truck" := 'Automatically added based on location';
    end;
}